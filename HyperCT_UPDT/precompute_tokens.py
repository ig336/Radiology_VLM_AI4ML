...
def precompute_single_volume(
    ...
    # Build RGB groups once (shared across all tasks)
    all_rgb = torch.stack(
    ...
    for task_idx in range(len(RADIOLOGICAL_TASKS)):
        ...
        # Image conditioning: match Stage 1 training which calls
        # set_image_conditioning() before generating LoRA weights.
        # Without this, the hypernet falls back to zero-vector conditioning,
        # producing different LoRA weights than what it learned during training.
