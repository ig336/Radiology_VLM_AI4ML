#!/bin/bash
#SBATCH --job-name=hyperct_precompute_valid
#SBATCH -p sablab-gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=24:00:00
#SBATCH --output=hyperct_precompute_valid_%j.out
#SBATCH --error=hyperct_precompute_valid_%j.err
...
python precompute_tokens.py \
    ...
    --preprocess_dir /midtier/sablab/scratch/isg4006/VLM_Project/Radiology_VLM_AI4ML/Radiology_VLM_AI4ML/HyperCT_UPDT/PreProcessed_valid1 \
    --output_dir ./precompute_tokens_valid_ff \
