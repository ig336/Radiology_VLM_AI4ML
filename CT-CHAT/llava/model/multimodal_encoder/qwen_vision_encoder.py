...
class Dinov3VisionEncoder(nn.Module):
    def __init__(self):
        ...
        self.model = AutoModel.from_pretrained("facebook/dinov3-vitb16-pretrain-lvd1689m").eval()
